    ...
    $(document).ready(function () {
        $('#capLong').html(cu ($('#capLong').html()))
    })

    $(document).ready(function () {
        $('#informationValue').html(cu ($('#informationValue').html()))
    })
    ...
    function liveRecv(data) {
        ...
        let { bids, asks, trades, assetsHolding, cashHolding, highcharts_series, news} = data;
    ...
    function sendOffer(is_bid) {
        ...
        if (limitPrice == undefined || limitPrice <= 0) {
            ...
            return // If you care about misspecified orders in your data, you may uncomment the return
        }
